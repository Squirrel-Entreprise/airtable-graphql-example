...
type ComplexityRoot struct {
	Mutation struct {
		AddToCart   func(childComplexity int, orderID string, productID string, quantity int) int
		CreateOrder func(childComplexity int, name string, address string) int
	}
...
type MutationResolver interface {
	CreateOrder(ctx context.Context, name string, address string) (string, error)
	AddToCart(ctx context.Context, orderID string, productID string, quantity int) (bool, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.addToCart":
		...
		return e.complexity.Mutation.AddToCart(childComplexity, args["order_id"].(string), args["product_id"].(string), args["quantity"].(int)), true
	...
	case "Mutation.createOrder":
		...
		return e.complexity.Mutation.CreateOrder(childComplexity, args["name"].(string), args["address"].(string)), true
...
var sources = []*ast.Source{
	{Name: "graph/schema.graphqls", Input: `"Catégories de produit"
enum Category {
  VEGETABLE
  FRUIT
}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateOrder(rctx, args["name"].(string), args["address"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_addToCart(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().AddToCart(rctx, args["order_id"].(string), args["product_id"].(string), args["quantity"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Product_category(ctx context.Context, field graphql.CollectedField, obj *model.Product) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCategory2airtaleᚋgraphᚋmodelᚐCategory(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_products(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNProduct2ᚕᚖairtaleᚋgraphᚋmodelᚐProductᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Product(ctx context.Context, sel ast.SelectionSet, obj *model.Product) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "cover":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Product_cover(ctx, field, obj)
			}
...
func (ec *executionContext) unmarshalNCategory2airtaleᚋgraphᚋmodelᚐCategory(ctx context.Context, v interface{}) (model.Category, error) {
	var res model.Category
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNCategory2airtaleᚋgraphᚋmodelᚐCategory(ctx context.Context, sel ast.SelectionSet, v model.Category) graphql.Marshaler {
	return v
}
...
func (ec *executionContext) marshalNProduct2ᚕᚖairtaleᚋgraphᚋmodelᚐProductᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Product) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNProduct2ᚖairtaleᚋgraphᚋmodelᚐProduct(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNProduct2ᚖairtaleᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v *model.Product) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
